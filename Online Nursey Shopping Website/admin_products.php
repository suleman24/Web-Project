...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" value="add product" name="add_product" class="add-button">
   </form>
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="admin_products.php?update=<?php echo $fetch_products['id']; ?>" class="update-button">Update</a>
